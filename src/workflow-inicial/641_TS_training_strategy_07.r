...
PARAM$train$training <- c(202107,202104,202101,202012, 202011, 202010, 202009, 202008,202001, 201912, 201911,
  201910, 201909, 201908, 201907,201906,201905,201904)

PARAM$train$validation <- c(202102,202105)
PARAM$train$testing <- c(202103,202106,202108)
